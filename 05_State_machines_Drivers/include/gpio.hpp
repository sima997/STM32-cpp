...
public:
    ...
    enum class IrqEdge : uint32_t {Rising, Faling};
    static GPIO_TypeDef* A;
    static GPIO_TypeDef* B;
    static GPIO_TypeDef* C;
    static GPIO_TypeDef* D;
    static GPIO_TypeDef* E;
    static GPIO_TypeDef* F;
    ...
    void clear();
    void toggle();
    void enable_interrupt(IrqEdge edge);
